...
The effectiveness of the voluntary quitting model with and without the external variable are shown in Figure \ref{fig:vqgainlift}. Figure \ref{fig:vqgain2} shows that top 25\% of employees with high predicted retiring probabilities contains around 50\% of quitters, top 50\% contains about 66.7\% quitters, top 60\% contains 75\% of quitters, and top 70\% contains 91\% quitters in year 2011 for two models, compared to the baseline. Figure \ref{fig:vqlift2} indicates if HR department targets top 10\% of employees, the model 3 will get 40\% of quitters and the model with external variables will get 25\% of quitters in year 2011. If HR targets 25\% of employees, the model 3 will identify  around 20\% of quitters for two models. The lift chart also provides a target group for HR to  decide and modify their retention strategy and for researchers to effectively identify the quitting reasons or future study.
.
